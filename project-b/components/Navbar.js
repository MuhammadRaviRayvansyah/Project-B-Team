      ...
      <div className="h-16 max-w-[1200px] mx-auto px-[1rem] md:px-[2rem] flex items-center justify-between">
        <div className="flex items-center gap-[0.75rem]">
          ...
          <div className="flex flex-col">
            <span className="text-[16px] leading-[24px] font-semibold text-[#181c20] tracking-tight">RentWear</span>
        ...
        <div className="flex items-center gap-[1.5rem]">
          <nav className="flex items-center gap-[1rem]">
            <Link href="#" className="py-[0.5rem] text-[#2f3a4a] text-[14px] font-semibold">Beranda</Link>
            <Link href="#" className="text-[14px] text-[#44474c] hover:text-[#181c20] transition-colors py-[0.5rem]">Barang</Link>
            <Link href="#" className="text-[14px] text-[#44474c] hover:text-[#181c20] transition-colors py-[0.5rem]">Peminjaman</Link>
            <Link href="#" className="text-[14px] text-[#44474c] hover:text-[#181c20] transition-colors py-[0.5rem]">Riwayat</Link>
            <div className="h-4 w-px bg-[#e0e3e8] mx-[0.25rem] hidden sm:block" />
            <Link href="#" className="text-[14px] text-[#44474c] hover:text-[#ba1a1a] transition-colors py-[0.5rem]">Logout</Link>
          </nav>
